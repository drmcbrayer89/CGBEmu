...
static CPU_INSTRUCTION instruction_set[0xFF + 0x01] = {
    ...
    /* Second Row */
    [0x010] = {I_STOP, M_D8                        },
    [0x011] = {I_LD,   M_REG_D16,      R_DE        },
    [0x012] = {I_LD,   M_MEMREG_REG,   R_DE,    R_A},
    [0x013] = {I_INC,  M_REG,          R_DE        },
    [0x014] = {I_INC,  M_REG,          R_D         },
    [0x015] = {I_DEC,  M_REG,          R_D         },
    [0x016] = {I_LD,   M_REG,          R_D         },
    [0x017] = {I_RLA                               },
    [0x018] = {I_JR,   M_D8,                       },
    [0x019] = {I_ADD,  M_REG_REG,      R_HL,   R_DE},
    [0x01A] = {I_LD,   M_REG_MEMREG,   R_A,    R_DE},
    [0x01B] = {I_DEC,  M_REG,          R_DE        },
    [0x01C] = {I_INC,  M_REG,          R_E         },
    [0x01D] = {I_DEC,  M_REG,          R_E         },
    [0x01E] = {I_LD,   M_REG_D8,       R_E,        },
    [0x01F] = {I_SRA                               },
    /* Third Row */
